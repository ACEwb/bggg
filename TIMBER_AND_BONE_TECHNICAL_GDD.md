...
## Prototype Artifact
- A lightweight playable HTML prototype is included at `timber_and_bone_playable.html` to validate the core loop (chop -> gain wood -> buy upgrades -> escalate automation).
